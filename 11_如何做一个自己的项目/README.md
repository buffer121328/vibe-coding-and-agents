# 📖 第十一章：如何做一个自己的项目 —— 个人开发者与应届生 AI 落地通关全指南

欢迎来到 **《Vibe Coding 极速通关》第十一章：如何做一个自己的项目**！

在前面的章节中，我们已经掌握了从基础概念、开发脚手架、Dify 工作流，到 OpenCode / Trae 实战以及手搓 Agent、LangChain、LangGraph 的完整技术栈。
...
1. **[11.1 开源选型与二次开发：协议避坑与架构借力](./01_开源选型与二次开发_协议避坑与架构借力.md)**
   - **核心内容**：毛坯房精装修理念；GitHub 项目“四维黄金筛选法”；MIT / Apache 2.0 / BSD / GPL / AGPL / SSPL 协议深度剖析与商用红线；Fork 与 Upstream 同步；非侵入式插件化二次开发工程范式。

2. **[11.2 传统业务 AI 赋能：从普通 Web / 小程序到智能体系统](./02_传统业务AI赋能_从Web小程序到智能体应用.md)**
...
3. **[11.3 数据困境与业务深耕：拒绝玩具 Demo 与出彩功能设计](./03_数据困境与业务深耕_拒绝玩具Demo与出彩功能设计.md)**
   - **核心内容**：个人开发者最大的痛点——真实业务数据与反馈缺失；AI 合成数据偏离现实与脏数据缺失的致命伤；4 大破局方案；拒绝无脑堆叠代码；**案例重构**：如何把烂大街的“智能旅行助手”结合 **Three.js 3D 大屏规划、多约束冲突求解与突发天气实时自愈 Agent** 打造为杀手级项目！

4. **[11.4 求职与能力进阶：垂直微调、小模型降本与开源贡献](./04_求职与能力进阶_垂直微调_小模型降本与开源贡献.md)**
