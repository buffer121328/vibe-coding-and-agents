...
0. **[11.0 什么是生产级 Agent 项目：Demo 与生产级的分水岭](./00_什么是生产级Agent项目.md)**
...
3. **[11.3 数据困境与业务深耕：拒绝玩具 Demo 与出彩功能设计](./03_数据困境与业务深耕.md)**
...
4. **[11.4 求职与能力进阶：垂直微调、小模型降本与开源贡献](./04_求职与能力进阶.md)**
