...
| 文档同步 | `agents.md`、`.trae/rules/backend.md`、`reference/阶段01/phase_05_...md`（可选 openspec 四件套） | 项目惯例「每阶段同步文档」 |
...
10. 同步文档（`agents.md`、`.trae/rules/backend.md`、`reference/阶段01/phase_05_...md`）
