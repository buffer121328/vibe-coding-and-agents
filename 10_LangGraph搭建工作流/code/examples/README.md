...
| `06_memory_hitl_demo.py` | 06 Memory 与 Human-in-the-loop | Checkpointer 会话记忆 + `interrupt_before` 拦截 |
...
| `12b_multiagent_paradigms_demo.py` | 12 子图与多智能体全谱（范式节） | 三大范式各一张图：Router 分诊台 / Supervisor 循环派活 / Planner-Executor-Reviewer 改稿拉锯战 |
