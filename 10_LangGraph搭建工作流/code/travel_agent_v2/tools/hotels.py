...
from infra.scripts.location_trans import transform_location

# 业务库路径的唯一出处：infra/paths.py（由 biz_db 转出，四个工具都从这里拿，别再各写一份）
from infra.biz_db import BUSINESS_DB as db
