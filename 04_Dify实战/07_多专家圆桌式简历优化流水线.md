...
![JD匹配分析师 LLM 节点配置](./img/25_jd_matching_analyst_config.png)
...
![HR审核 LLM 节点配置](./img/26_hr_review_expert_config.png)
...
![内容优化师 LLM 节点配置](./img/27_content_optimizer_config.png)
...
![圆桌式复盘 System 提示词配置](./img/28_roundtable_host_system_prompt.png)
...
![圆桌式复盘多路上下文注入配置](./img/29_roundtable_host_user_prompt.png)
