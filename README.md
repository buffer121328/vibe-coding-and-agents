...
这三章沿着具体项目展开，依次练习任务编排、从零开发和已有功能的扩展。

| 章节 | 实践内容 | 阅读重点 |
| --- | --- | --- |
| [第四章：Dify 工作流实战](./04_Dify实战/README.md) | 模拟面试与简历优化 | 节点数据、会话状态、输出校验和发布验收 |
| [第五章：OpenCode 项目开发](./05_OpenCode实战/README.md) | 单文件工具、灵感卡片、个人博客 | 需求约定、配置排查、阶段交付和前后端联调 |
| [第六章：Trae 项目改造](./06_Trae实战/README.md) | 权限、评论点赞、AI 辅助写作与代码分层 | 现有功能保护、异常处理和改造边界 |

<!-- CH10-14_ROOT_INDEX -->

## 第 10—14 章：工作流、知识库、项目与工具选择

| 章节 | 主要内容 | 阅读时重点检查 |
| --- | --- | --- |
| [第十章：LangGraph 工作流](./10_LangGraph搭建工作流/README.md) | 状态、路由、并行、恢复、审批与部署 | 状态怎样更新，失败后怎样继续，外部操作是否会重复 |
| [第十一章：RAG 实战](./11_RAG实战/README.md) | 文档处理、检索、生成、评估与工程化 | 答案错误发生在哪一层，引用能否回到原文 |
| [第十二章：做自己的项目](./12_如何做一个自己的项目/README.md) | 开源选型、业务接入、数据与求职表达 | 范围是否明确，结果是否有可复现证据 |
| [第十三章：AI 与时代变化](./13_如何看待AI对时代的意义/README.md) | 效率、岗位变化、学习与责任边界 | 研究、类比和个人建议是否区分清楚 |
| [第十四章：正确使用 Agent 工具](./14_如何正确的使用agent工具/README.md) | 能力边界、计费、订阅、模型接入和对话方法 | 动态信息是否重新核对，权限与成本是否可控 |
...
- **12-14｜对 Agent 与 AI 的思考与高效驾驭（认知碰撞与实战指南）**：包含做自己的生产级项目、时代思考，以及第十四章的 AI 能力界限、Token 计费算账、订阅选型、海外模型访问与提问/会话管理心法。
