...
> 本节将带你进行第一次 **OpenCode 意图驱动破冰实战**：通过 OpenCode 的原生 **Plan（规划）** 与 **Build（构建）** 模式，结合本地项目级 Skills 技能，从 0 到 1 打造一对赛博朋克极客小工具 —— **《赛博极客解压木鱼》** 与 **《专注番茄钟》**！
...
在上一节 [5.2 高级配置](./02_高级配置：MCP、Skills及omo_slim.md) 中，我们学习了功能强大的 `oh-my-opencode-slim` 多专家智囊团和 MCP 扩展坞。但在第一次破冰实战中，我们特意采用**极简纯净方案**：
...
通过这个对比，大家可以清晰地看到：**Skills 绝不是约束 AI 的紧箍咒，而是为 AI 智能体量身定制的“特种作战战术包”**！它把人类资深工程师在特定领域的最佳实践与规范直接注入到了 AI 的思维里。

***

## 📝 七、本节小结与 Vibe Coding 沉淀
