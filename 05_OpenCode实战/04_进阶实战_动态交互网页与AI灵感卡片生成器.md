...
我们在 [5.2 节](./02_高级配置_MCP与Skills及omo_slim实战.md) 中深度对比过：原版 OMO 往往存在大量上下文冗余与 Token 浪费，而 `omo-slim` 采用了**极简模块化架构**，不仅大幅降低 Token 消耗，还支持将多个专家角色自由绑定到任意模型（包括完全免费的模型）上！
...
👉 **[5.5 极简全栈：FastAPI 与 SQLite 个人博客系统实战](./05_极简全栈_FastAPI与SQLite个人博客实战.md)**：
