# 3.4 主流 Agent 工具链下载与实战配置

> **大白话一句话概括**：有了前几节准备好的 Python 环境与 API Key，现在是时候给你的数字工位装上最趁手的“神兵利器”了！本节带你手把手安装配置 Trae、Claude Code CLI、Cursor 与 Cline！
...
graph TD
    ...
    subgraph CLI ["2. 终端命令行 Agent 门派 (极客全自主)"]
        C1["Claude Code (Anthropic 官方终端智能体)"]
        C2["OpenCode / Codex CLI (开源命令行代码助手)"]
    end

    subgraph Ext ["3. VS Code 开源插件门派 (高自由度 + MCP)"]
        E1["Cline (透明工具流 + 自定义模型)"]
        E2["Roo Code (多角色定制)"]
    end
```
...
- **官网下载**: [https://www.trae.ai](https://www.trae.ai)
...
- **官方文档**: [https://docs.anthropic.com/en/docs/agents-and-tools/claude-code](https://docs.anthropic.com/en/docs/agents-and-tools/claude-code)
...
- **官网下载**: [https://www.cursor.com](https://www.cursor.com)
- **关键配置技巧**：
